...
class WL_Product_Thumbnails_Zoom_ELement extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Thumbanils', 'woolentor-pro' ),
    ...
    protected function render() {
        ...
        <?php if( Plugin::instance()->editor->is_edit_mode() ){ echo '</div>'; } ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new WL_Product_Thumbnails_Zoom_ELement() );