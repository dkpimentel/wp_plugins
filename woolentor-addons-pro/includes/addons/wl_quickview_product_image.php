...
class WL_Quickview_Product_Thumbnail_ELement extends Widget_Base {
...
Plugin::instance()->widgets_manager->register_widget_type( new WL_Quickview_Product_Thumbnail_ELement() );