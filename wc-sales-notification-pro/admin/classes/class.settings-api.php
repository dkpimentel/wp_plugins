...
if ( !class_exists( 'WC_Pro_Sale_Notification_Settings_API' ) ):
class WC_Pro_Sale_Notification_Settings_API {
            ...
            <?php foreach ( $this->settings_sections as $form ) { ?>
                <div id="<?php echo $form['id']; ?>" class="group" style="display: none;">
                    <form method="post" action="options.php">
                        ...
                        ?>
                        <div class="wcsales-submit-button" style="padding-left: 10px">
                            <?php submit_button(); ?>
                        </div>
                        <?php endif; ?>
                    </form>
