    ...
    public function purchased_products(){
        ...
        if ( ! $products ) {
            $args = array(
                ...
                'orderby' => 'ID',
                'order' => 'DESC',
                'posts_per_page' => wcsales_get_option_pro( 'notification_limit','wcsales_settings_tabs','5' ),
                'date_query' => array(
                    'after' => date('Y-m-d', strtotime('-'.wcsales_get_option_pro('notification_uptodate','wcsales_settings_tabs','5' ).' days'))
                )
            );
                ...
                if( !empty( $order_items ) ) {
                    ...
                    if( !empty( $product ) ){
                        ...
                        $p = array(
                            ...
                            'image' => count($imgurl) === 2 ? $imgurl[1] : WCPRO_SALENOTIFICATION_PL_URL.'/admin/assets/images/fake_data_placeholder.png',
